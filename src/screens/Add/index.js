...
const Add = ({ navigation }) => {
  ...
  // untuk menampilkan atau menyembunyikan modal yang memungkinkan pengguna menambahkan kategori baru.
  const toggleModal = () => {
  ...
  // ata catatan (notes) diambil menggunakan fungsi getNote saat komponen ini di-mount atau ketika fokus navigasi berubah.
  useEffect(() => {
    const fetchData = async () => {
      ...
      // Data kategori unik kemudian dihasilkan dari catatan, dan disimpan dalam state categoryUser untuk digunakan dalam opsi kategori catatan baru.
  ...
  // Pengguna dapat memilih kategori catatan dari opsi yang sudah ada.
  // untuk menambahkan kategori baru melalui modal, yang mengubah state newCategory saat pengguna memasukkan teks.
